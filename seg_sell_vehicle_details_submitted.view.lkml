view: seg_sell_vehicle_details_submitted {
  ...
  dimension: aftermarket_modifications {
    type: string
    sql: ${TABLE}.aftermarket_modifications ;;
  }
  ...
  dimension: color_exterior {
    type: string
    sql: ${TABLE}.color_exterior ;;
  }

  dimension: color_interior {
    type: string
    sql: ${TABLE}.color_interior ;;
  }

  dimension: color_moto {
    type: string
    sql: ${TABLE}.color_moto ;;
  }

  dimension: condition_cosmetic {
    type: number
    sql: ${TABLE}.condition_cosmetic ;;
  }

  dimension: condition_mechanical {
    type: number
    sql: ${TABLE}.condition_mechanical ;;
  }

  dimension: condition_moto {
    type: number
    sql: ${TABLE}.condition_moto ;;
  }

  dimension: condition_tires {
    type: number
    sql: ${TABLE}.condition_tires ;;
  }
  ...
  dimension: current_damage {
    type: string
    sql: ${TABLE}.current_damage ;;
  }
